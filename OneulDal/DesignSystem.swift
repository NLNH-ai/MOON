...
enum MoonLayout {
    ...
    static let heroDateTextSize: CGFloat = 27
    static let heroPhaseTitleTextSize: CGFloat = 50
    static let heroPhaseSubtitleTextSize: CGFloat = 22
    static let nextMoonTitleTextSize: CGFloat = 27
    static let nextMoonDateTextSize: CGFloat = 20
    static let nextMoonCountdownTextSize: CGFloat = 28
    static let nextMoonChevronOpacity: Double = 0.60
    ...
    static let monthPreviewActionOpacity: Double = 0.70
    static let monthPreviewActionTextSize: CGFloat = 18
    static let monthPreviewTitleTextSize: CGFloat = 26
    static let monthPreviewTopPadding: CGFloat = 18
    static let previewMoonPercentOpacity: Double = 0.76
    ...
    static let statusMetricTextSize: CGFloat = 18
    static let statusMetricIconSize: CGFloat = 23
    static let statusMetricIconFrameSize: CGFloat = 30
    static let statusMetricContentSpacing: CGFloat = 7
    ...
    static let timeIconSize: CGFloat = 28
    static let timeLabelTextSize: CGFloat = 21
    static let timeMetricStackSpacing: CGFloat = 12
    static let timeMetricLabelSpacing: CGFloat = 8
    static let timeValueFontSize: CGFloat = 39
}
